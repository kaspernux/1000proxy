...
use App\Filament\Clusters\Shop\Resources\CartItemResource\Pages;
use App\Filament\Clusters\Shop\Resources\CartItemResource\RelationManagers;
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('user_id')
                    ->required()
                    ->numeric(),
                Forms\Components\Select::make('server_client_id')
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('user_id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('serverClient.id')
                    ->numeric()
                    ->sortable(),
