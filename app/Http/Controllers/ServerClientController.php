    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $serverClient = ServerClient::create([
                ...
                'limit_ip' => $clientResponse['limit_ip'] ?? 1,
                'total_gb_bytes' => $clientResponse['totalGB'] ?? 0,  // Store bytes directly from 3X-UI API
                'expiry_time' => isset($clientResponse['expiry_time']) ? now()->createFromTimestampMs($clientResponse['expiry_time']) : null,
                'tg_id' => $clientResponse['tg_id'] ?? null,
                'subId' => $subId,
