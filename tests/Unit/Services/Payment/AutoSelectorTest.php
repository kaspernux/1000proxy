...
{
    /** @test */
    public function selects_wallet_when_sufficient_balance()
    {
    ...
    /** @test */
    public function falls_back_to_crypto_when_wallet_insufficient()
    {
    ...
    /** @test */
    public function selects_crypto_when_wallet_inactive()
    {
    ...
    /** @test */
    public function falls_back_to_first_active_when_no_wallet_no_crypto()
    {
    ...
    /** @test */
    public function returns_nulls_when_no_active_methods()
    {
