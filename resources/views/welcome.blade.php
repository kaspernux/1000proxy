...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>1000Proxy - Premium Proxy & VPN Solutions</title>
                            ...
                            <div class="flex items-center space-x-4">
                                @auth
                                    <a href="{{ url('/dashboard') }}"
                                       class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-emerald-600 rounded-lg hover:bg-emerald-700 transition-colors duration-200">
                                        <x-custom-icon name="chart-bar" class="h-4 w-4 mr-2" />
                                        Dashboard
                                    </a>
                                @else
                                    <a href="{{ route('login') }}"
                                       class="inline-flex items-center px-4 py-2 text-sm font-medium text-slate-300 hover:text-white transition-colors duration-200">
                                    ...
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}"
                                           class="inline-flex items-center px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-emerald-500 to-blue-600 rounded-lg hover:from-emerald-600 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl">
            ...
            <main>
                <div class="relative isolate px-6 pt-14 lg:px-8">
                    ...
                    <div class="mx-auto max-w-4xl py-32 sm:py-48 lg:py-56">
                        <div class="text-center">
                            ...
                            <div class="mt-10 flex items-center justify-center gap-x-6">
                                ...
                                <a href="#features"
                                   class="inline-flex items-center text-lg font-semibold leading-6 text-slate-300 hover:text-white transition-colors duration-200">
                                    <x-custom-icon name="magnifying-glass" class="h-5 w-5 mr-2" />
                                    Learn more
                                </a>
                            </div>
                            ...
                            <div class="mt-16 grid grid-cols-2 gap-8 sm:grid-cols-4">
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-emerald-400">500K+</div>
                                    <div class="text-sm text-slate-400">Active Users</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-3xl font-bold text-blue-400">150+</div>
                                    <div class="text-sm text-slate-400">Server Locations</div>
                                </div>
                                <div class="text-center">
                    ...
                    <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]" aria-hidden="true">
                        <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-purple-400 to-emerald-600 opacity-20 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
                    </div>
                </div>
