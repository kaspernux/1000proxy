            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    <div
                        ...
                        <div>
                            <input type="range" class="w-full h-1 mb-4 bg-yellow-600 rounded appearance-none cursor-pointer" max="200" value="1" step="1">
                    ...
                    <div class="flex flex-wrap items-center ">
                        @foreach($serverPlans as $serverPlan)
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                                <div class="group flex flex-col bg-green-700 border-double rounded-lg border-2 border-yellow-600 ">
                                    <div class="relative bg-green-600">
                                        <a wire:navigate href="/servers/{{$serverPlan->name}}" class="">
                                            <img src="{{ url('storage/'.$serverPlan->product_image)}}" alt="{{$serverPlan->name}}"
                                                class="object-cover h-[16rem] w-full py-4 px-4 items-center justify-center">
                                        </a>
                                    </div>
                                    <div class="p-3 hover:text-green-900">
                                        ...
                                        <p class="text-lg hover:after:text-white">
                                            <span class="text-yellow-600  dark:text-yellow-600 text-xl">$ {{$serverPlan->price}}</span>
                                        </p>
                                    </div>
                                    <div class="flex justify-center p-4 border-t border-yellow-600  hover:bg-yellow-600 dark:bg-dark-green dark:focus:ring-green-600 dark:border-yellow-600 shadow-sm hover:shadow-md transition dark:focus:outline-none dark:focus:ring-1 disabled:opacity-50 disabled:pointer-events-none">

                                        <a href="#"
                                            class="text-white flex items-center space-x-2 dark:text-white hover:text-green-900">
