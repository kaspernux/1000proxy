                        ...
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    @error('email')
                                    <div class="py-3 absolute inset-y-0 end-0 items-center pointer-events-none pe-3">
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    ...
                                    <a wire:navigate
                                        class="text-sm text-accent-yellow decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
