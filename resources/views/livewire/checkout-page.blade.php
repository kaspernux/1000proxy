<div class="w-full bg-gradient-to-r from-green-900 to-green-600 container max-w-auto py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                ...
                <button class="bg-green-400 mt-4 w-full p-3 rounded-lg text-lg text-white hover:bg-yellow-600">
                    Place Order
                </button>
