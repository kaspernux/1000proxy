    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a wire:navigate class="flex-none text-xl font-bold text-white hover:text-yellow-600 dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-green-600"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate class="font-mono {{request()->is('/') ? 'text-accent-yellow' : 'text-white'}} hover:text-yellow-600 py-3 md:py-6 dark:text-green-400 dark:hover:text-yellow-600 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-green-600"
                            href="/" aria-current="page">Home</a>

                        <a wire:navigate class="font-mono {{request()->is('categories') ? 'text-accent-yellow' : 'text-white'}} hover:text-yellow-600 py-3 md:py-6 dark:text-green-400 dark:hover:text-yellow-600 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-green-600"
                            href="/categories">
                            Categories
                        </a>

                        <a wire:navigate class="font-mono {{request()->is('products') ? 'text-accent-yellow' : 'text-white'}} hover:text-yellow-600 py-3 md:py-6 dark:text-green-400 dark:hover:text-yellow-600 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-green-600"
                            href="/servers">
                            Products
                        </a>

                        <a wire:navigate class="font-mono flex items-center {{request()->is('cart') ? 'text-accent-yellow' : 'text-white'}} hover:text-yellow-600 py-3 md:py-6 dark:text-green-400 dark:hover:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-green-600"
                            href="/cart">
                            ...
                            <span class="mr-1">Cart</span> <span
                                class="py-0.5 px-1.5 rounded-full text-xs font-mono bg-green-400 border border-white text-white">{{$total_count}}</span>
                        </a>
