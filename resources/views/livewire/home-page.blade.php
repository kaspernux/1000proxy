<div>
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    ...
                    <p class="mt-3 text-lg text-gray-300">Optimize your internet experience with cutting-edge VPN and
                        Proxy
                    ...
                    <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                        ...
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-gray-800 text-gray-200 shadow-sm hover:bg-gray-700 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/contact">
                            Contact Sales Team
                        </a>
                    </div>
    ...
    <section class="py-14 font-poppins dark:bg-gray-800">
        <div class="max-w-7xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold text-light-green">Anonymous and secured<span
                            class="text-accent-green"> VPN & Proxy</span></h1>
        ...
        <div class="justify-center max-w-7xl px-4 py-4 mx-auto lg:py-0">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                <div class="bg-light-dark rounded-lg shadow-md">
                    <a href="" class="">
                    ...
                    <div class="p-5 text-center">
                        <a href="" class="text-2xl font-bold tracking-tight text-light-green">Apple</a>
                    </div>
                </div>
                ...
                <div class="bg-light-dark rounded-lg shadow-md">
                    ...
                    <div class="p-5 text-center">
                        <a href="" class="text-2xl font-bold tracking-tight text-light-green">Samsung</a>
                    </div>
                </div>
                ...
                <div class="bg-light-dark rounded-lg shadow-md">
                    ...
                    <div class="p-5 text-center">
                        <a href="" class="text-2xl font-bold tracking-tight text-light-green">One Plus</a>
                    </div>
                </div>
                ...
                <div class="bg-light-dark rounded-lg shadow-md">
                    ...
                    <div class="p-5 text-center">
                        <a href="" class="text-2xl font-bold tracking-tight text-light-green">Xiaomi</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-gradient-to-r from-dark-green to-accent-green py-20">
        <div class="max-w-7xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold text-light-green">Explore <span
                            class="text-accent-green">Categories</span></h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-gradient-to-r from-green-200 to-green-500"></div>
                    </div>
                </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">
                                <img class="h-[2.375rem] w-[2.375rem] rounded-full"
                                    ...
                                    alt="Laptops">
                                <div class="ms-3">
                                    <h3 class="group-hover:text-accent-green font-semibold text-light-green">Laptops
                                    </h3>
                                </div>
                            </div>
                            <div class="ps-3">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">
                                <img class="h-[2.375rem] w-[2.375rem] rounded-full"
                                    ...
                                    alt="Smartphones">
                                <div class="ms-3">
                                    <h3 class="group-hover:text-accent-green font-semibold text-light-green">Smartphones
                                    </h3>
                                </div>
                            </div>
                            <div class="ps-3">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center">
                                <img class="h-[2.375rem] w-[2.375rem] rounded-full"
                                    ...
                                    alt="Television">
                                <div class="ms-3">
                                    <h3 class="group-hover:text-accent-green font-semibold text-light-green">Television
                                    </h3>
                                </div>
                            </div>
                            <div class="ps-3">
    ...
    <section class="py-14 font-poppins dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 py-6 lg:py-8 md:px-6">
            <div class="max-w-xl mx-auto">
                <div class="text-center">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold text-light-green dark:text-gray-200">Customer <span
                                class="text-accent-green">Reviews</span></h1>
                        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                            <div class="flex-1 h-2 bg-gradient-to-r from-green-200 to-green-500"></div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="bg-light-dark rounded-lg shadow-md dark:bg-gray-700 py-6">
                    <div
                        ...
                        <div class="flex items-center px-6 mb-2 md:mb-0">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-green-500 dark:text-green-400">
                                    Adren Roy</h2>
                                <p class="text-xs text-gray-700 dark:text-green-400">Web Designer</p>
                            </div>
                        </div>
                        {{-- <p class="px-6 text-base font-medium text-green-700 dark:text-green-400"> Joined 12, SEP , 2022
                        </p> --}}
                    </div>
                    <p class="px-6 mb-6 text-base text-white dark:text-green-400">
                        Enhance your online privacy and security with advanced VPN and proxy configurations tailored to
                        your
                        needs. Stay
                        anonymous and protect your data with the latest technology solutions.
                    </p>
                                ...
                                <li>
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            class="w-4 mr-1 text-green-500 dark:text-green-400 bi bi-star-fill"
                                            viewBox="0 0 16 16">
                                            <path
                            ...
                            <div class="flex items-center">
                                <div class="flex mr-3 text-sm text-green-700 dark:text-green-400">
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            class="w-4 h-4 mr-1 text-green-400 bi bi-hand-thumbs-up-fill"
                                            viewBox="0 0 16 16">
                                            <path
                                ...
                                <div class="flex text-sm text-white dark:text-gray-400">
                                    <a href="#" class="inline-flex hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="w-4 h-4 mr-1 text-green-400 bi bi-chat"
                                            viewBox="0 0 16 16">
                                            <path
