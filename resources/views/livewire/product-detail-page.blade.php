<div
    ...
    <section class="overflow-hidden container mx-auto px-4 max-w-7xl border-2 rounded-lg bg-white py-11 font-poppins dark:bg-green-400">
                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 ">
                            <h2 class="max-w-xl mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">
                                USA Residential - Reality TCP</h2>
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>$4.99</span>
                                <span
                                    class="text-base font-normal text-gray-500 line-through dark:text-gray-400">$9.99</span>
                            </p>
                            <p class="max-w-md text-gray-700 dark:text-gray-400">
                                Elevate your online security and performance with our advanced 3X UI Based Proxy Server Configuration. Perfect for both
                                personal use and business environments, our proxy server offers a seamless, user-friendly experience combined with
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button
                                class="w-full p-4 bg-green-400 rounded-md lg:w-2/5 dark:text-white text-white hover:bg-yellow-600 dark:bg-green-400 dark:hover:bg-yellow-600">
                                Add to cart</button>
                        </div>
                    </div>
                </div>
