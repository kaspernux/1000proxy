<div class="w-full bg-gradient-to-r from-green-900 to-green-600 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto ">
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6">

            <a class="group flex flex-col bg-green-400 border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-green-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-green-600"
                href="#">
                <div class="p-4 md:p-5">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center">
                            ...
                            <div class="ms-3">
                                <h3
                                    class="group-hover:text-green-700 text-2xl font-semibold  text-white dark:group-hover:text-green-700 dark:text-green-400">
                                    Socks5
                                </h3>
                            </div>
                        </div>
