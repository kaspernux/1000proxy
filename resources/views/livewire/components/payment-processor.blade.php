<div class="payment-processor bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
    {{-- Payment Progress Indicator --}}
    <div class="mb-6">
        <div class="flex items-center justify-between mb-2">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Payment Process</h3>
    ...
    @if($paymentStep === 'select_gateway')
        {{-- Gateway Selection --}}
        <div class="space-y-4">
            <h4 class="font-medium text-gray-900 dark:text-white mb-4">Select Payment Method</h4>
                ...
                @foreach($availableGateways as $gatewayKey => $gateway)
                    @if($gateway['enabled'])
                        <div
                            ...
                            class="payment-gateway-option p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 {{ $selectedGateway === $gatewayKey ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300' }}"
                        >
            ...
            @if($selectedGateway === 'stripe')
                ...
                <div class="mt-6 p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
                    <h5 class="font-medium text-gray-900 dark:text-white mb-4">Card Information</h5>
            ...
            @elseif($selectedGateway === 'nowpayments')
                ...
                <div class="mt-6 p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
                    <h5 class="font-medium text-gray-900 dark:text-white mb-4">Select Cryptocurrency</h5>

                    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                        @foreach($cryptoCurrencies as $crypto => $details)
                            <div
                                wire:click="selectCrypto('{{ $crypto }}')"
                                class="crypto-option p-3 border-2 rounded-lg cursor-pointer transition-all duration-200 {{ $selectedCrypto === $crypto ? 'border-orange-500 bg-orange-50 dark:bg-orange-900/20' : 'border-gray-200 dark:border-gray-600 hover:border-gray-300' }}"
                            >
            ...
            @elseif($selectedGateway === 'wallet')
                {{-- Wallet Payment Info --}}
                <div class="mt-6 p-4 border border-gray-200 dark:border-gray-600 rounded-lg">
                    <h5 class="font-medium text-gray-900 dark:text-white mb-4">Wallet Balance</h5>
    ...
    @elseif($paymentStep === 'processing')
        ...
        <div class="text-center py-8">
            ...
            <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Processing Payment</h4>
    ...
    @elseif($paymentStep === 'completed')
        ...
        <div class="text-center py-8">
            ...
            <h4 class="text-lg font-semibold text-green-600 dark:text-green-400 mb-2">Payment Successful!</h4>
    ...
    @elseif($paymentStep === 'failed')
        ...
        <div class="text-center py-8">
            ...
            <h4 class="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">Payment Failed</h4>
            <p class="text-gray-600 dark:text-gray-400 mb-4">
