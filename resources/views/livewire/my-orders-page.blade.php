    ...
    <section class="w-full max-w-7xl mx-auto relative z-10">
        ...
        <header class="text-center mb-12">
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-4 mt-8">
                <a href="{{ route('filament.customer.pages.order-management') }}" 
                   class="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-2xl font-semibold transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-105 ring-1 ring-blue-500/30">
                ...
                <a href="{{ route('filament.customer.pages.server-browsing') }}" 
                   class="group inline-flex items-center px-8 py-4 bg-white/10 hover:bg-white/20 text-white rounded-2xl font-semibold transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-105 ring-1 ring-white/20 backdrop-blur-sm">
